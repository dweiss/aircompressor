 ...
 * {@code BZip2InputStream} to release the allocated memory. See
 ...
 * {@link #BZip2InputStream(InputStream, boolean)}.
 * </p>
 *
 * <p>
        ...
        extends InputStream
{
    ...
    /**
     * Constructs a new BZip2InputStream which decompresses all the concatenated
     ...
     * @throws NullPointerException if {@code in == null}
     */
    public BZip2InputStream(InputStream in, boolean decompressConcatenated)
    {
    ...
    /**
     * Constructs a new BZip2InputStream that decompresses the blocks of the
     ...
     */
    public BZip2InputStream(InputStream in, boolean decompressConcatenated, ExecutorService executor, int maxConcurrentInFlight)
    {
